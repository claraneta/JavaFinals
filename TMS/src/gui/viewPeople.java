...
public class viewPeople extends javax.swing.JFrame {
    ...
    public viewPeople(DefaultTableModel model){
        this.model = model;
        initComponents();
    }
    public viewPeople() {
    ...
    private void initComponents() {
        ...
        btncreateAccount.setFont(new java.awt.Font("Courier New", 0, 14)); // NOI18N
        btncreateAccount.setText("Create Person Account");
